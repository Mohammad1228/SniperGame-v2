...
function EnemeyMoves(E){
   var playerXpos= player.body.x;
   var playerYpos= player.body.y;
   var enemyXpos = E.body.x;
   var enemyYpos = E.body.y;
if(!bounceOffWall(E.body)){


   if(playerXpos - enemyXpos > 0 ){
    if(playerYpos-enemyYpos>0){
       E.body.velocityX = 2;
         E.body.velocityY = 2;
    }  
    if(playerYpos-enemyYpos<0){
   ...
   if(playerXpos - enemyXpos < 0 ){
    ...
    E.body.velocityX = E.body.velocityX*(-1);
    E.body.velocityY = E.body.velocityY*(-1); 
